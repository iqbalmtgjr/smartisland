...
<head>
    <meta charset="utf-8" />
    <title>{{ config('app.name') }} Lemukutan</title>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5">
        <a href="/" class="navbar-brand d-flex align-items-center">
            <h1 class="m-0 text-primary">
                <img class="img-fluid me-3" src={{ asset('asset/img/icon/logo-navbar-2.png') }} alt="" />SMART
                ISLAND
            </h1>
        </a>
            ...
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <h1 class="text-white mb-4">
                        <img class="img-fluid me-3" src="asset/img/icon/logo-navbar-2.png" alt="" />
                    </h1>
                </div>
                <div class="col-lg-3 col-md-6">
